                        ...
                        <div class="px-4 py-5 bg-white sm:p-6 shadow sm:rounded-tl-md sm:rounded-tr-md">
                            <div class="grid grid-cols-6 gap-6">
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="text" name="name" id="name" value="{{ auth()->user()->name }}" class="mt-1 p-2 block w-full border border-gray-300 focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                    <span id="name-err" class="hidden text-sm text-red-500"></span>
                                </div>
                                <!-- Email -->
                                <div class="col-span-6 sm:col-span-4">
                                    <label class="block font-medium text-sm text-gray-700">Email</label>
                                    <input type="email" name="email" id="email" value="{{ auth()->user()->email }}" class="mt-1 p-2 block w-full border border-gray-300 focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                <div class="col-span-6 sm:col-span-4">
                                    ...
                                    <input type="text" name="phone" id="phone"  maxlength="11" value="{{ implode('', explode('-', auth()->user()->phone)) }}" class="number mt-1 p-2 block w-full border border-gray-300 focus:outline-none focus:ring-2 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
